...
<head id="Head1">
    ...
    <script type="text/javascript" src="static/js/jquery.easyui.js"></script>
    ...
    <script type="text/javascript">
	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"系统管理",
							"menus":[
									{"menuname":"添加用户","icon":"icon-add","url":"user/add"},
									{"menuname":"用户管理","icon":"icon-users","url":"user/find"}/* ,
...
/* 	 var _menus = {"menus":[
						{"menuid":"1","icon":"icon-sys","menuname":"系统管理",
							"menus":[{"menuname":"菜单管理","icon":"icon-nav","url":"http"},
...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
        ...
        <span style="padding-left:10px; font-size: 16px; "><img src="static/images/blocks.gif" width="20" height="20" align="absmiddle" /> CRM管理系统</span>
    </div>
